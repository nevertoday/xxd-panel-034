...
| --- | --- | --- |
| `top-bottom` | user-confirmed whole canvas | one complete generation: high-fidelity source above, 034 design below, approximately 50/50 |
| `left-right` | user-confirmed whole canvas | one complete generation: high-fidelity source left, 034 design right, approximately 50/50 |
| `design-only` | user-confirmed whole canvas | 034 design fills the canvas; source remains invisible |
