<p align="center">
  <img src="./assets/banner.svg" alt="XXD Panel 034 프로젝트 배너" width="1200">
</p>
...
[![Four Modes](https://img.shields.io/badge/Modes-4-d75d32?style=flat-square)](#네-가지-출력-하나의-고무도장-현장-기록-시스템)
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090719303784104086"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 034 예시 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090719303784104086"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 034 예시 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090719303784104086"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 034 예시 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090719303784104086"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 034 예시 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 034 예시 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 034 예시 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 034 예시 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 034 예시 8"></td>
  </tr>
</table>

## 추가 3:4 상하 구성 예시

위 16:9 예시와 같은 네 개의 독립 소스를 완전한 3:4 상하 캔버스로 다시 생성했습니다. 위쪽은 현실 사진을 유지하고 아래쪽은 Panel 034의 원본 프롬프트에 따라 재구성합니다. 영어 문구는 각 사진의 내용·분위기·함의에서만 생성했으며 모든 결과를 개별 검수했습니다.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 034 추가 상하 예시 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 034 추가 상하 예시 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 034 추가 상하 예시 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 034 추가 상하 예시 4"></td>
  </tr>
</table>

> [샤오샤오둥（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2090719303784104086) · 2026-08-21<br>
> GPT2 x 断墨 x 印章 x 油墨 x 美学提示词 x VOL.034

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2090719303784104086">원문 게시물과 전체 프롬프트 보기 →</a></p>

이 예시는 034의 미학적 의도를 보여 줄 뿐이며, 예시의 주제, 구성, 색상, 문구, 이전 캔버스 비율은 생성 참고나 현재 기본값이 되지 않습니다.

> 작은 도장 · 2–4가지 별색 · 손으로 판 선 · 따뜻한 종이 · 현장 주석

XXD Panel 034는 Codex와 호환 에이전트를 위한 이미지 생성 Skill입니다. 불필요한 세부를 덜어 내고 사진의 주체, 윤곽, 자세, 방향, 공간 관계와 서사를 작고 식별 가능한 다색 고무도장 하나로 다시 만듭니다.

원본에서 얻은 2–4가지 별색, 불균일한 조각선, 끊긴 잉크, 종이 노출, 가장자리 결손, 압력 변화, 미세한 판 어긋남, 따뜻한 섬유 종이, 넓은 여백과 작은 타자기 주석이 관광 기념품이 아닌 여행자의 수집 기록을 만듭니다.
...
**Panel 034**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **사진을 작은 다색 고무도장과 조용한 현장 기록으로**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
...
> XXD Panel 034으로 이 이미지를 작업하고, 먼저 가장 어울리는 구성과 크기를 추천해 줘.
...
## 빠른 판단: XXD Panel 034이 나에게 맞을까요?

| 궁금한 점 | 이 스타일이 주는 답 |
|---|---|
| **얻게 되는 결과** | 사진을 작은 다색 고무도장과 조용한 현장 기록으로 |
| **한눈에 알아볼 특징** | 작은 도장 · 2–4가지 별색 · 손으로 판 선 · 따뜻한 종이 · 현장 주석 |
...
일반적인 ‘여행 도장’은 둥근 기념 배지, 우표 템플릿, 여권 도장, 스티커 세트나 고정 복고 팔레트로 쉽게 무너집니다.

034는 그 순서를 뒤집습니다.

```text
정체성／방향／공간 관계 고정 → 불필요한 세부 삭제 → 작은 식별 도장 하나로 축약 → 원본 기반 2–4 별색 분리 → 불균일한 양각·음각선으로 재구성 → 끊긴 잉크·압력 변화·종이 노출·결손·미세 판 어긋남 추가 → 넓고 따뜻한 종이 여백에 배치 → 근거 있는 제목과 필요한 미세 주석 정렬
```

무관한 사진으로 바꿔도 도장 윤곽, 남긴 단서, 별색 분리, 위치, 여백 관계, 조각선 방향 또는 주석이 거의 달라지지 않는다면 034가 아닙니다.

## 완성작에서 바로 알아볼 수 있는 스타일 특징

- **원본 정체성:** 최소 세 가지 구체적 단서로 비율, 윤곽 흐름, 자세, 방향, 동작, 기능과 관계를 보존합니다.
- **작은 도장 하나:** 실루엣, 별색 면, 불균일한 조각선, 음각과 필요한 겹침으로 작은 크기에서도 원본을 식별합니다.
- **넓은 활성 여백:** 따뜻한 밝은 섬유 종이가 불완전한 인상을 조용하고 수집 가능하게 보이게 합니다.
- **원본 기반 2–4 별색:** 각 색이 구조 영역, 층 또는 강조 역할을 갖고 미세한 판 어긋남을 허용합니다.
- **물리적 인상:** 끊긴 잉크, 종이 노출, 입자, 결손, 압력 변화와 불균일한 조각선이 인쇄 구조를 따릅니다.
- **자유롭지만 근거 있는 배치:** 원본 방향과 무게가 편심, 가장자리, 필요한 크롭을 결정합니다.
- **현장 주석:** 작은 대상 언어 타자기체나 기록 미세 문자를 도장 가장자리, 기준선, 윤곽 또는 여백에 맞춥니다.
...
이미지 폴더를 직접 전달하면 이 병사 Skill이 같은 Panel 034의 원본 미학으로 일괄 처리합니다. 일반 래스터 형식을 기본적으로 재귀 탐색하고 수량을 먼저 알린 뒤 모드·크기·텍스트·언어를 한 번만 확인합니다. 각 이미지는 내용이나 문구가 섞이지 않도록 독립 생성하며 전체 배치는 하나의 평면 작업 디렉터리만 사용합니다. 개별 실패는 기록하고 이후 이미지를 조용히 누락하지 않습니다.
...
/xxd-panel-034 photo.jpg --mode top-bottom --size auto --text prompt --locale ko-KR

# 좌우 비교: 3:2 가로형, 글자 없음
/xxd-panel-034 photo.jpg --mode left-right --size 3:2 --text none

# 디자인 전용: 9:16 휴대폰 세로형, 한국어 문구
/xxd-panel-034 photo.jpg --mode design-only --size 9:16 --text prompt --locale ko-KR
...
/xxd-panel-034 photo.jpg --mode design-only --size 3:4 --text prompt --locale ko-KR

# 정확한 문구를 재작성·번역·제목 추가 없이 사용
/xxd-panel-034 photo.jpg --mode design-only --size 3:4 --copy "빛을 이곳에 남겨 두기" --locale ko-KR

# 2개 모드 × 3개 크기로 독립적인 완성 구도 6개 생성
/xxd-panel-034 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ko-KR

# 폴더 전체에 Panel 034 적용, 공통 설정은 한 번만 확정
/xxd-panel-034 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ko-KR
...
Claude Code 사용자는 같은 폴더를 `~/.claude/skills/xxd-panel-034`에 연결할 수 있습니다. 설치 후 에이전트 세션을 다시 시작하세요.
...
- [Skill 워크플로](SKILL.md)
- [중문 런타임 어댑터](references/xxd-panel-034-prompt.zh-CN.md)
- [영문 런타임 어댑터](references/xxd-panel-034-prompt.en.md)
...
**사진은 현장을 기록하고, 도장은 기억에 필요한 것만 남깁니다.**
