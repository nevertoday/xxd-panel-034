...
لهذا الإحباط صنعت **Panel 034**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **يختزل الصورة إلى ختم مطاطي صغير متعدد الألوان وملاحظة ميدانية هادئة**.
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 034 نموذج 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 034 نموذج 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 034 نموذج 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 034 نموذج 8"></td>
  </tr>
</table>
